...
when "rhel"
  ...
  yum_key "RPM-GPG-KEY-swift-extras" do
    url "http://download.opensuse.org/repositories/home:/rpcops:/havana/CentOS_CentOS-6/repodata/repomd.xml.key"
    action :add
  end
  ...
  yum_repository "swift-extras" do
    ...
    url "http://download.opensuse.org/repositories/home:/rpcops:/havana/CentOS_CentOS-6/"
    type "rpm-md"
  end
