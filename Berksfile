...
cookbook 'osops-utils', git: 'git://github.com/rpedde-rcbops/osops-utils', branch: 'grizzly'
...
cookbook 'keystone', git: 'git://github.com/rpedde-rcbops/keystone', branch: 'grizzly'
