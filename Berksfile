...
cookbook 'dsh', git: 'git://github.com/rcbops-cookbooks/dsh', branch: '9e190aaad7db3f2195df1a9e48c7678b89a3c1cf'
cookbook 'osops-utils', git: 'git://github.com/rpedde-rcbops/osops-utils', branch: 'role_whackery'
