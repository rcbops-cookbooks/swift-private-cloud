...
$ips = {
  :chef_server => "192.168.122.10",
  :management_server => "192.168.122.20",
  :storage_server_1 => "192.168.122.31",
  :storage_server_2 => "192.168.122.32",
  :storage_server_3 => "192.168.122.33",
  :proxy_server_1 => "192.168.122.41",
  :proxy_server_2 => "192.168.122.42"
}
...
Vagrant.configure("2") do |config|
  ...
  config.vm.define :chef_server do |server|
    server.vm.hostname = "vagrant-chef-server"
    server.vm.network :private_network, :ip => $ips[:chef_server]
...
require_relative "./Vagrantfile.d/#{ENV["CONFIGURATION"] || "reference"}.rb"
